...
public class Board {
    ...
    public boolean checkStalemate(boolean team) {
        boolean stalemate = false;
        if (!this.blackCheck && !this.whiteCheck) {//if neither player is in check
            this.calculateChildren(team);
            if (this.children.size() == 0) {//if this team cannot move
                stalemate = true;
            }
        }
